...
/*
 * Prints out the structures as defined in memory.	Good for
 * check that you make file does what you want (and for debugging
 * make).
 */
void
prt()
...
/*
 * Look for circular dependancies. ie. a: b b: a is a circular dep
 */
void
circh()
{
